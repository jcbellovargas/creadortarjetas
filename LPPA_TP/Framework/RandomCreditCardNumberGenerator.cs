...
namespace CreditCardNumberGenerator
{
     ...
     * Typically 13 or  16
        */
        ...
        public static decimal GenerateCreditCardNumber(string entity) {
            if (entity == "Visa"){
                return Decimal.Parse(GenerateVisaCardNumber());
            }
            else if (entity == "Mastercard"){
                return Decimal.Parse(GenerateMasterCardNumber());
            }
            else{
                return Decimal.Parse(GenerateAmexCardNumber());
            }
        }
